...
class MahasiswaController extends Controller
{
    ...
    //functionFungsi dari code dibawah yaitu pembuatan function Create dan kemduian data yang akan kita Create akan masuk ke dalam database project tersebut.
